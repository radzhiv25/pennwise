...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background p-3 [--cell-size:theme(spacing.8)] [--cell-radius:var(--radius)]",
      ...
      classNames={{
        ...
        weekday: cn(
          "flex w-[var(--cell-size)] items-center justify-center rounded-[var(--cell-radius)] text-[0.8rem] font-normal text-muted-foreground select-none",
        ...
        day: cn(
          "group/day relative flex w-[var(--cell-size)] aspect-square items-center justify-center rounded-[var(--cell-radius)] p-0 text-center select-none [&:last-child[data-selected=true]_button]:rounded-r-[var(--cell-radius)]",
